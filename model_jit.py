...
def JiT_B_16(**kwargs):
    return JiT(depth=12, hidden_size=768, num_heads=12, in_context_len=32, in_context_start=4,
...
def JiT_L_16(**kwargs):
    return JiT(depth=24, hidden_size=1024, num_heads=16, in_context_len=32, in_context_start=8,
               bottleneck_dim=128, patch_size=16, **kwargs) 
...
def JiT_H_16(**kwargs):
    return JiT(depth=32, hidden_size=1280, num_heads=16, in_context_len=32, in_context_start=10,
