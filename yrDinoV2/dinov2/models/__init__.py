...
def build_model_from_cfg(cfg, only_teacher=False):
    student, teacher, embed_dim = build_model(cfg.student, only_teacher=only_teacher, img_size=cfg.crops.global_crops_size)

    if cfg.MODEL.PRETRAINED:
        pretrained = torch.load(cfg.MODEL.PRETRAINED, map_location='cpu')
